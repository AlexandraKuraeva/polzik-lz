...
export default function Form({user}) {
	...
	const [state, formAction, isProcessing ] = useActionState(actionTransaction, initialState)
console.log(state);
	return (
      ...
      <input type="hidden" name="userId" value={user.id} />
        ...
        <div className='mb-4'>
			...
			<div className='mt-6 flex justify-end gap-4'>
				...
				<Button type='submit' disabled={isProcessing}>{isProcessing ? 'Загрузка...' : 'Сохранить'}</Button>
			</div>
		</form>
	)
}
